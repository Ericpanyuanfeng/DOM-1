...
// 增
var div1 = dom.create("<div id='create'><span>div1</span></div>");
console.log(div1);
var a2_5 = dom.create("<span id='a2_5'></span>");
dom.after(a2, a2_5); // 需要先创建再添加

var b0_5 = dom.create("<span id='b0_5'></span>");
dom.before(b1, b0_5);
var append1 = dom.create("<div id='append1'></div>");
dom.append(append, append1);
var w0 = dom.create("<div id='w0'></div>");
...
var testDiv2 = dom.find('#test2');
console.log(testDiv2);
var p = dom.parent(son1);
console.log(p);
